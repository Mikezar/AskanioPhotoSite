...
namespace AskanioPhotoSite.Data.Storage
{
    public sealed class Storage : IStorage
    {
        ...
        public Storage()
        {
            ...
            _repositories.Add(typeof(Watermark), new GenericRepository<Watermark>(this));
        }
        ...
        public void UpdateCache(ICache cache)
        {
            ...
            cache.AddEntity(Execute(new Query<Watermark>() { QueryType = QueryType.Read, ActionType = ActionType.Select }).Result.ToList());
            cache.IsActual = true;
